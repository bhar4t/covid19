...
export default function PrivacyPolicy() {
  return (
    <div style={{ padding: 12 }}>
      <h1>Privacy Policy for http://corona-in.web.app</h1>

      <p>
        At Corona19 - India, accessible from http://corona-in.web.app, one of
        ...
        Corona19 - India and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Corona19 - India. This policy is not applicable
      ...
      <p>
        Corona19 - India follows a standard procedure of using log files. These
      ...
      <p>
        ...
        advertising partners of Corona19 - India.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Corona19 - India, which are sent
      ...
      <p>
        Note that Corona19 - India has no access to or control over these
      ...
      <p>
        Corona19 - India's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Corona19 - India does not knowingly collect any Personal Identifiable
      ...
      <p>
        Github repository: https://github.com/bhar4t/covid19.git (An Open-Source
        Application)
      </p>
    </div>
  );
